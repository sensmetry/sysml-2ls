...
export interface Element extends AstNode {
    readonly $container: AcceptActionUsage | AnnotatingElement | AssignmentActionUsage | Connector | Dependency | Expression | Feature | FeatureReferenceExpression | ForLoopActionUsage | IfActionUsage | ItemFlow | Multiplicity | Namespace | OperatorExpression | PortDefinition | Relationship | SatisfyRequirementUsage | SendActionUsage | SysMLFunction | TransitionUsage | Type | WhileLoopActionUsage;
