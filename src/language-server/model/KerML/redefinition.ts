...
import { SubsettingMeta } from "./subsetting";

@metamodelOf(Redefinition)
export class RedefinitionMeta extends SubsettingMeta {
    constructor(id: ElementID, parent: ModelContainer<Redefinition>) {
        super(id, parent);
    }

    override self(): Redefinition | undefined {
        return super.self() as Redefinition;
    }
