...
import { ReferenceSubsetting } from "../../../generated/ast";
...
> extends SubsettingMeta<T> {
    constructor(id: ElementID, parent: ModelContainer<ReferenceSubsetting>) {
        super(id, parent);
    }
    ...
    override parent(): ModelContainer<ReferenceSubsetting> {
        return this._parent;
    }
}
