...
export const SysMLGrammar = (): Grammar => loadedSysMLGrammar ?? (loadedSysMLGrammar = loadGrammarFromJson(`{
  ...
  "rules": [
    ...
    {
      "$type": "ParserRule",
      "name": "EmptyAssignmentActionMember",
      "returnType": {
        "$ref": "#/interfaces@58"
      },
      "definition": {
    ...
    {
      "$type": "ParserRule",
      "name": "TargetAccessedFeatureMember",
      "returnType": {
        "$ref": "#/interfaces@62"
      },
      "definition": {
