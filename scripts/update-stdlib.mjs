...
export const STDLIB = {
    version: "${CURRENT_TAG}",
    tree: "https://github.com/daumantas-kavolis-sensmetry/SysML-v2-Release/blob/release/${CURRENT_TAG}/sysml.library/",
    raw: "https://raw.githubusercontent.com/daumantas-kavolis-sensmetry/SysML-v2-Release/release/${CURRENT_TAG}/sysml.library/",
    files: [
